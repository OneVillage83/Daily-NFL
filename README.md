...
- M3 Raw Evidence & Provider Abstraction: F-2 static audit/remediation complete; local quality and real-provider certification gates pending
...
- Current M3 audit authority: `docs/implementation/M3_ARCHITECTURE_CONFORMANCE_AUDIT.md`
